...
CREATE TABLE `dic_conference_room_type`  (
  ...
  `code` int NULL DEFAULT NULL COMMENT '类型编码',
...
CREATE TABLE `ref_conference`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `conference_room_id` bigint NOT NULL COMMENT '会议室id',
  `conference_room_appointment_id` int NOT NULL COMMENT '预约id',
  ...
  `starttime_code` int NULL DEFAULT NULL COMMENT '开始时间编码',
  `endtime_code` int NULL DEFAULT NULL COMMENT '结束时间编码',
...
CREATE TABLE `t_admin`  (
  ...
  `username` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '教职工号',
  ...
  `creat_time` datetime NULL DEFAULT NULL COMMENT '创建管理员时间',
  `update_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改管理员时间',
  `isdel` bit(1) NULL DEFAULT NULL COMMENT '是否删除（0：删除1：未删除）',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_conference_room`  (
  ...
  `capacity` int NULL DEFAULT NULL COMMENT '会议室容量',
  `status` int NULL DEFAULT NULL COMMENT '会议室状态\r\n（1：可使用、2：维修）',
  `equipment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备',
  `conference_room_type_code` int NULL DEFAULT NULL COMMENT '会议室类型编码',
...
CREATE TABLE `t_conference_room_appointment`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '预约者姓名',
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '预约者工号（用户唯一标识）',
  `conference_room_id` bigint NULL DEFAULT NULL COMMENT '会议室id',
  `max_num` int NULL DEFAULT NULL COMMENT '最多参会人数',
  ...
  `starttime_code` int NULL DEFAULT NULL COMMENT '会议开始时间',
  `endtime_code` int NULL DEFAULT NULL COMMENT '会议结束时间',
  `examine_status` int NULL DEFAULT 0 COMMENT '审核状态（0：未处理；1：管理员审核通过；2：系主任审核通过；3：管理员审核未通过 ;4:系主任审核未通过..，，,目前用0，1，3）',
...
CREATE TABLE `t_notice`  (
  ...
  `author_number` bigint NULL DEFAULT NULL COMMENT '教职工号',
...
CREATE TABLE `t_participants`  (
  ...
  `mailbox` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮箱',
...
CREATE TABLE `t_rules`  (
  ...
  `title` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公告标题',
  `authoruuid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '管理员登录的uuid',
  `author_number` int NULL DEFAULT NULL COMMENT '教职工号',
  `author_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '作者名',
  `creat_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '公告内容',
...
CREATE TABLE `t_user`  (
  ...
  `username` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '教职工号（唯一标识）',
  ...
  `status` smallint NULL DEFAULT 0 COMMENT '审核状态（0：未处理，1：已通过，2：不通过）',
...
INSERT INTO `t_user` VALUES (53, NULL, '2023', '123', 'wjw', NULL, '710890083@qq.com', '计算机', NULL, '2023-01-21 07:09:20', NULL, b'1', 1, NULL);
...
CREATE TABLE `user_info`  (
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '由uuid生成',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名（真实姓名）',
  `user_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户工号（唯一标识）',
  `depart_id` int NOT NULL COMMENT '离职id',
  `sex_id` smallint NULL DEFAULT NULL COMMENT '性别（0：男，1：女）',
  `birthday` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '生日',
  `user_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电话号',
  `user_card` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '卡号',
  `user_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `user_password` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '密码',
  `user_signature` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '签名',
  `register_time` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '注册时间',
  `user_headportrait` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '头像',
  `activity_level` smallint NULL DEFAULT 0 COMMENT '事件等级',
  `isfollow` bit(1) NULL DEFAULT NULL COMMENT '是否关注',
  `follownum` bigint NOT NULL COMMENT '关注数量',
  `fans` bigint NOT NULL COMMENT '粉丝',
